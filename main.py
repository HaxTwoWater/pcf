...
class pfcGame
    ...
    def gameIntro():
        ...
        print("Meilleur score actuel est de : " + highScore " !")
        ...
        #Exception en cas d'erreur de l'essaie
            ...
            print("Erreur mauvais type de valeur rentrer")
            #Retour de l'execution de la fonction gameIntro
            gameIntro()
    ...
    def match(x):
        ...
        if playerScore > highScore:
            print("Vous avez carrément dépasser le record depuis que le jeu est lancé qui était de " + highScore " avec un score de " + playerScore " !")
            highScore = playerScore
        else:
            notEnough = highScore - playerScore
            print("Vous n'avez pas dépasser le record actuel qui est de " + highScore + " retentez votre chance la prochaine fois il ne vous manquez que " + notEnough " !")
